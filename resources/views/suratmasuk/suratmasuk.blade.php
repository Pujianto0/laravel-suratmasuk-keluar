...
<body>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" integrity="sha512-3pIirOrwegjM6erE5gPSwkUzO+3cTjpnV9lexlNZqvupR64iZBnOOTiiLPb9M36zpMScbmUNIcHUqKD47M719g==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <div>
      <a href="/tambahsuratmasuk"class="btn btn-success">Tambah +</a><br>
      <br>
  </div>
</div>
</div>
...
<div class="dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" href="/tampilkandata/{{ $row->id }}">Update</a></li>
    <li><a class="dropdown-item" href="/exportpdf2/{{$row->id}}">Export PDF</a></li>
...
<script>
    $('.delete').click(function () {
        ...
        var suratmasuknosurat = $(this).attr('data-nosurat');

        swal({
            title: "Yakin ?",
            text: "Kamu akan menghapus data surat masuk dengan No Surat  " + suratmasuknosurat + " ",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/delete1/" +suratmasukid+ " "
